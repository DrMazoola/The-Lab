...
I was able to use this command to send the `clear` command to MPC before turning on the `media_player` in Home Assistant and thus preventing MPD from trying to load the last played Chime_tts mp3.  I have a more detailed write up of my solution [here](../HomeAssistant/MPD_Login_Attempt.md).
```yaml
